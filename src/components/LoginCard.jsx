...
const LoginCard = () => {
  ...
  const manejarRegistro = async (e) => {
    ...
    if (regForm.dni && !dniRegex.test(regForm.dni))
      errors.push('DNI inválido. Debe contener 7 u 8 dígitos')
    ...
    const resultado = registrar
      ? registrar({
          usuarioNombre: regForm.nombre,
          username: regForm.username,
          password: regForm.password,
          dni: regForm.dni,
          institucion: regForm.institucion
        })
      : null
